...
type QueryFormValues = z.infer<typeof blogSchema>;
...
export function WriteBlog({ onQuerySubmit, isLoading }: BlogProps) {
  ...
  return (
    <Card className="box-border !w-[calc(100vw-50px)] border-none p-0 shadow-none sm:!w-[500px]">
      <CardHeader className="flex w-full flex-col items-center gap-1 p-0 text-center sm:px-5">
        <CardTitle className="text-2xl font-bold">Write Blog</CardTitle>
      </CardHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input {...field} placeholder="How to take whiskey.." className="text-sm" />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Textarea
                      {...field}
                      placeholder="Compose your latest article or blog entry..."
                      className="text-sm"
                    />
                  </FormControl>
                  <FormMessage />
