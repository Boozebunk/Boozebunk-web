            ...
            <SidebarGroupContent>
              <SidebarMenu className="gap-2">
                ...
                <SidebarMenuItem>
                  <SidebarMenuButton asChild className="p-5 py-6">
                    <Button
                      className="flex items-center justify-start gap-2 border-none !px-5"
                      variant={'outline'}
                      onClick={() => setOpenQuery(true)}>
                      <Mail className="mr-2 !size-6" />
                      <span className="text-[17px] font-medium">Write Us</span>
                    </Button>
                  </SidebarMenuButton>
                </SidebarMenuItem>
              </SidebarMenu>
              ...
              <SidebarMenu>
                <SidebarMenuItem>
                  <SidebarMenuButton asChild className="mb-2 p-5 py-6">
                    <Link
                      href={`/vendor-portal/${session?.id}/vendor/${session?.roleId}/stock-list`}>
